...
export default function PlacePage(){
        ...
        return(
            <div className="absolute inset-0 bg-black text-white min-h-screen">
                <div className="bg-black p-8 grid gap-4">
                    <div>
                        <h2 className="text-3xl mr-48">Imágenes de {place.title}</h2>
    ...
    return(
        <div className="mt-4 bg-gray-100 mx-8 px-8 py-8">
            ...
            <div className="mb-4 mt-8 grid gap-8 grid-cols-1 md:grid-cols-[2fr_1fr]">
                <div>
                    <div className="my-4">
                    ...
                    Max. número de Huéspedes: {place.maxGuests}  <br />
            ...
            <div>
                <div className="bg-white -mx-8 px-8 py-8 border-t">
                    <div>
                        <h2 className="font-semibold text-2xl">Info Extra</h2>
                    </div>
