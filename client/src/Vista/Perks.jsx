    ...
    return(
        <>
            <label className="border p-4 flex rounded-2xl gap-2 cursor-pointer">
                        ...
                        <label className="border p-4 flex rounded-2xl gap-2 cursor-pointer">
                            <input type="checkbox" name='Estacionamiento' onChange={handleCbClick} />
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                        ...
                        <label className="border p-4 flex rounded-2xl gap-2 cursor-pointer">
                            <input type="checkbox" name='Mascotas' onChange={handleCbClick}/>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                        ...
                        <label className="border p-4 flex rounded-2xl gap-2 cursor-pointer">
                            <input type="checkbox" name='Portero' onChange={handleCbClick}/>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
